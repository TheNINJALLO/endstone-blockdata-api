...
CONFIG = {"project": "blockdata","slug": "endstone-blockdata-api","plugin_prefix": "endstone_blockdata_bds_","bridge_prefix": "_endstone_blockdata_live","wheel_prefix": "endstone_blockdata_inspector","version": "0.4.8"}
...
class TestReleaseTools(unittest.TestCase):
    ...
    def test_workflow_uses_stable_checks_and_requires_tagged_main_commit(self):
        ...
        self.assertNotIn("Portable tests v0.4.8", workflow)
        self.assertNotIn("Exact v0.4.8 - BDS", workflow)
    ...
    def add_command_wheel(stage: Path) -> Path:
        wheel = (
            stage / "plugins" /
            "endstone_blockdata_inspector-0.4.8-cp314-cp314-win_amd64.whl"
        )
