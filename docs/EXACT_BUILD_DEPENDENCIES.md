...
`conanfile.py` pins the dependency versions for Endstone 0.11.6. `scripts/build_exact.py` configures the public Endstone Cloudsmith remote, installs the graph with Conan 2, and passes the generated CMake toolchain into the exact BDS 1.26.33 build.
