...
[![Version](https://img.shields.io/badge/version-v0.4.9-blue.svg?style=for-the-badge)](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/tag/v0.4.9)
...
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux-orange.svg?style=for-the-badge)](#-direct-release-downloads-v049)
...
| :--- | :--- | :--- | :--- |
| **Windows x64 ZIP (recommended)** | `1.26.33` | `endstone-blockdata-api-v0.4.9-bds-1.26.33-windows-x64.zip` | [Download](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/download/v0.4.9/endstone-blockdata-api-v0.4.9-bds-1.26.33-windows-x64.zip) |
| **Linux x64 ZIP (recommended)** | `1.26.33` | `endstone-blockdata-api-v0.4.9-bds-1.26.33-linux-x64.zip` | [Download](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/download/v0.4.9/endstone-blockdata-api-v0.4.9-bds-1.26.33-linux-x64.zip) |
| **Windows x64 raw plugin** | `1.26.33` | `endstone-blockdata-api-v0.4.9-bds-1.26.33-windows-x64.dll` | [Download](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/download/v0.4.9/endstone-blockdata-api-v0.4.9-bds-1.26.33-windows-x64.dll) |
| **Linux x64 raw plugin** | `1.26.33` | `endstone-blockdata-api-v0.4.9-bds-1.26.33-linux-x64.so` | [Download](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/download/v0.4.9/endstone-blockdata-api-v0.4.9-bds-1.26.33-linux-x64.so) |
| **Windows `/bd` wheel** | `CPython 3.14` | `endstone_blockdata_inspector-0.4.9-cp314-cp314-win_amd64.whl` | [Download](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/download/v0.4.9/endstone_blockdata_inspector-0.4.9-cp314-cp314-win_amd64.whl) |
| **Linux `/bd` wheel** | `CPython 3.14` | `endstone_blockdata_inspector-0.4.9-cp314-cp314-linux_x86_64.whl` | [Download](https://github.com/TheNINJALLO/endstone-blockdata-api/releases/download/v0.4.9/endstone_blockdata_inspector-0.4.9-cp314-cp314-linux_x86_64.whl) |
